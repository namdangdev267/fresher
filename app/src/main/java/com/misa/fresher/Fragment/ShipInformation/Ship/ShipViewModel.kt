...
class ShipViewModel(context: Context): ViewModel()  {
    ...
    init {
        listItemShip.add(ItemShipInfor.ItemRadioButton(context.getString(R.string.organization),context.getString(
            R.string.personal)))
        listItemShip.add(ItemShipInfor.ItemTouch(context.getString(R.string.receiver),context.getString(R.string.touch_to_select),
        ...
        listItemShip.add(ItemShipInfor.ItemTouch(context.getString(R.string.tracking_no),context.getString(
