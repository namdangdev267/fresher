...
class CustomToolbar : LinearLayout {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        ...
        val menuSrc = a.getResourceId(R.styleable.CustomToolbar_menuBtnSrc, 0)
        ...
        btnMenu.setImageResource(menuSrc)
        ...
        val btnQrCode = findViewById<ImageButton>(R.id.btnQrCode)
