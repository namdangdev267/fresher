...
class EditTextCustom : LinearLayout {
    constructor(context: Context) : super(context)

    lateinit var hintSearch: EditText
...
//
//        hintSearch = findViewById<EditText>(R.id.edtSearchHint)
//        hintSearch.hint = title
//
...
//        hintSearch.doAfterTextChanged {
//            listener(hintSearch.text.toString())
//        }
//    }
