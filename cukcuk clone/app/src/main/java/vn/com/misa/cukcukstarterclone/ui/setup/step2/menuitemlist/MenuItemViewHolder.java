...
public class MenuItemViewHolder extends BaseViewHolder<MenuItem> {
    ...
    private final OnItemClickListener<MenuItem> deleteListener;
    ...
    public MenuItemViewHolder(@NonNull View itemView,
                              OnItemClickListener<MenuItem> listener,
                              OnItemClickListener<MenuItem> deleteListener) {
        ...
        ivClose = itemView.findViewById(R.id.tvClose);
        ...
        try {
            ...
            ivClose.setOnClickListener(v -> {
                if (null != deleteListener) {
                    deleteListener.onClick(item, getAdapterPosition());
                }
            });
        } catch (Exception e) {
